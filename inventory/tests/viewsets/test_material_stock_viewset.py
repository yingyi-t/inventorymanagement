...
class MaterialStockViewSetTest(APITestCase):
    def setUp(self):
        ...
        self.material_stock = MaterialStockFactory(store=store, material=material, current_capacity=20, max_capacity=100)
    ...
    def test_put_material_stock_max_capacity_valid(self):
        ...
        self.assertEqual(MaterialStock.objects.get(material=self.material_stock.material).max_capacity, 200)
    ...
    def test_put_material_stock_current_capacity(self):
        ...
        self.assertEqual(MaterialStock.objects.get(material=self.material_stock.material).current_capacity, 20)
    ...
    def test_put_material_stock_max_capacity_less_than_current_capacity(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(MaterialStock.objects.get(material=self.material_stock.material).max_capacity, 100)
